...
const DocCourseData = ({courselist, loading}) => {
                    ...
                    courses.map((course) => {
                        return (
                            <tr>
                                ...
                                <td><button onClick={()=>history.push({pathname:"/adminactions/adddocument", state:{id:course.id}})} className="btn btn-primary">Выбрать</button></td>
                            </tr>
                        )
                    } )
                :
