...
import VideoCourseData from './VideoCourseData';
    ...
    return(
        <div className="container">
            <div >
                ...
                <h4>Выберите курс чтобы туда добавить видео</h4>
            </div>
            <form className="mt-3">
            ...
            {courses.length>0 ?
            <>
            <VideoCourseData courselist={currentCourses} loading={loading}></VideoCourseData>
            <Pagination
